             ...
             <div className="px-4">
                {suggestions.map((item) => (
                  <Link 
                    ...
                    className="flex items-center justify-between p-4 rounded-2xl hover:bg-mioji-light transition-all group"
                  >
                     ...
                     <ArrowRight className="w-4 h-4 text-gray-200 group-hover:text-mioji-red group-hover:translate-x-1 transition-all" />
                  </Link>
                ))}
             </div>
             <Link 
               href={`/products?q=${query}`}
               className="flex items-center justify-center gap-3 mt-6 p-6 text-[10px] font-black uppercase tracking-[0.2em] text-black hover:text-mioji-red transition-all border-t border-gray-50 bg-gray-50/30"
             >
