  ...
  const cartItems = [
    {
      ...
      image: "https://placehold.co/200x200/F9F9F9/111827?text=Product",
      price: 1249.00,
      quantity: 1,
      variant: "Siyah"
    }
           ...
           {cartItems.length > 0 ? (
             <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-8 space-y-6">
                   {cartItems.map((item) => (
                      <div key={item.id} className="flex items-center gap-6 p-6 rounded-3xl bg-[#F9F9F9] border border-[var(--color-mioji-border)]">
                         ...
                         <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-1">{item.variant}</p>
                ...
                <div className="lg:col-span-4">
                   <div className="bg-white rounded-[2.5rem] border border-[var(--color-mioji-border)] p-8 shadow-2xl shadow-gray-100">
                      ...
                      <div className="space-y-4 mb-8">
                         ...
                         <div className="pt-4 border-t border-gray-100 flex justify-between items-end">
                            ...
                            <span className="font-black text-2xl text-mioji-red">
